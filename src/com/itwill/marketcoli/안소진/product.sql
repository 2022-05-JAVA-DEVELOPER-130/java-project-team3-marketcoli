...
-----insert
insert into product(p_no,p_name,p_price,p_exp,p_category_b,p_category_s) values (product_p_no_seq.nextval,'백설공주사과',5000,'맛있어요','채소/과일','과일');
 
-----delete
delete from product where p_no=24;
select * from product;
